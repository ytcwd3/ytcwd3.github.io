      ...
      try {
        const { error } = await supabase
          ...
          .update({
            ...
            quarkcode: item.new.quarkcode || "",
            baidupan: item.new.baidupan,
            baiducode: item.new.baiducode || "",
            thunderpan: item.new.thunderpan,
            thundercode: item.new.thundercode || "",
        ...
        const { error } = await supabase.from("games").insert([
          {
            ...
            quarkcode: game.quarkcode || "",
            baidupan: game.baidupan,
            baiducode: game.baiducode || "",
            thunderpan: game.thunderpan,
            thundercode: game.thundercode || "",
